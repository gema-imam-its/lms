...
import DeleteSesiButton from "@/components/guru/DeleteSesiButton";
import MulaiSesiButton from "@/components/guru/MulaiSesiButton";
...
export default async function DaftarSesiSiswa({
  ...
  async function mulaiPraktikSekarang(
    ...
    if (error) {
      ...
      if (error.code === "23505") {
        return {
          error: "Alat baru saja dipakai siswa lain. Coba lagi beberapa saat.",
        };
      }
              ...
              >
                <div className="flex-1">
                  ...
                  <div className="flex flex-wrap gap-4 text-sm font-gilroy text-gray-500 mb-4 lg:mb-0">
                    ...
                    <span className="flex items-center gap-1">
                      <Activity size={16} /> {session.durasi_detik} detik
                    </span>
                  </div>
                </div>
                ...
                <div className="flex flex-wrap items-center gap-4 lg:gap-8">
                  <div className="text-center">
                    ...
                    <div className="font-gohan text-3xl text-gema-tosca">
                      {score}%
                    </div>
                  </div>
                  ...
                  <div className="flex gap-2 w-full lg:w-auto mt-4 lg:mt-0">
                    ...
                    <Link
                      ...
                      className="min-h-12 px-6 bg-gema-navy text-white rounded-xl font-gohan font-bold hover:bg-gema-tosca transition-colors flex items-center justify-center w-full sm:w-auto"
                    >
                      Detail &rarr;
                    </Link>
                  </div>
