...
import { getLessonById } from "@/data/lessons/nama-gerakan-sholat";
import { LessonPlayer } from "@/components/modul/LessonPlayer";

export default async function ModulPlayerPage({
  params,
}: {
